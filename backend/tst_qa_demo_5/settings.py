"""
Django settings for tst_qa_demo_5 project.
...
ROOT_URLCONF = 'tst_qa_demo_5.urls'
...
WSGI_APPLICATION = 'tst_qa_demo_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_qa_demo_5 API",
    "DESCRIPTION": "API documentation for tst_qa_demo_5 App",
    "VERSION": "v1",
}
